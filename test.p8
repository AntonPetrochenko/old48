...
function m_bat(x,y)
	...
	local p=
	{
		...
		update=function(self)
			...
			if time()%2==1 then
				p = m_projectile(self.x,self.y,2)
				add(objects,p)
			end
			--move in x
			self.x+=self.dx
...
function m_projectile(x,y,vel)
	p = {
		...
		y=y,
		t=0,
		dx = -cos(vec_angle(p1.x,p1.y,x,y))*vel,
		dy = -sin(vec_angle(p1.x,p1.y,x,y))*vel,

		draw = function(self)
			circfill(self.x,self.y,3,3)
			circfill(self.x,self.y-256,3,3)
		end,
		update = function(self)
			self.t+=1
			if self.t>60 then
...
function generator(current_y)
	...
	if rnd(10)<1 and not fget_at(spawn_x_tile*8,(target-1)*8,0) then
...

...

...
__gff__

...

...

