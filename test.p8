					...
					for id,object in pairs(objects) do
						if object.drillable and distance(self.x,self.y,object.x,object.y) < 8 then
							if object.gilded then
								self.drilling_timer = 60
								self.drilled_sprite = object.curframe
								music(0)
							end
							objects[id] = nil
...
function generator(current_y)
	...
	for i,v in pairs(objects) do
		if p1.y > v.y and p1.y - v.y > 160 then
			objects[i] = nil
			sfx(0)
		end
	end
	...
	if target%3==0 then
		...
		while platform_budget > 1 do
			local platform_spending = rnd(platform_budget)
			platform_budget -= platform_spending
			platform(rnd(8)+4,target,platform_spending,69)
...
function reset()
	...
	p1=m_player(64,100)
	bat=m_bat(80,100)
	turtle=m_turtle(30,100)
	scull=m_scull(12,100)
	crab=m_crab(60,170)
	crab_hand_left=m_crab_hand_left(50,170)
	crab_hand_right=m_crab_hand_right(82,170)
	p1:set_anim("walk")
	bat:set_anim("walk")
	turtle:set_anim("walk")
	scull:set_anim("walk")
	crab:set_anim("stand")
	crab_hand_left:set_anim("stand")
	crab_hand_right:set_anim("stand")
...
function _update60()
	...
	turtle:update()
	scull:update()
	crab_hand_left:update()
	crab_hand_right:update()
...
function _draw()
	...
	printc("★miner vasya★",64,4,10,1,0)
...

...
00000000007070000070700000777700007777000070700000778870077877000778700007787000077870000770000007700000077000000007070700070707
...

...
__gff__

__map__

...

